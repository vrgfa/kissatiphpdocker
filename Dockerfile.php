...
mkdir -p /usr/src/tmp/ioncube && \
    ...
    cp /usr/src/tmp/ioncube/ioncube/ioncube_loader_lin_7.0.so /etc/php/7.0/fpm/php.ini \
    cp /usr/src/tmp/ioncube/ioncube/ioncube_loader_lin_7.0.so /etc/php/7.0/php.ini
